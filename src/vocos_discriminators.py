""" 
vocos_discriminators
  - Desc: Deprecated file of the vocos discriminators, seemed to result in a bit of instability in training the model, especially the
  period discriminator. Instead going to train on the v2 discriminators
"""
...
class MultiPeriodDiscriminator(nn.Module):
    ...
    def forward(
        ...
        for d in self.discriminators:
            ...
            y_d_r = d(x=y, cond_embedding_id=bandwidth_id)
            y_d_g = d(x=y_hat, cond_embedding_id=bandwidth_id)
    ...
    def __init__(
        ...
        self.convs = nn.ModuleList(
            [
                ...
                weight_norm(Conv2d(128, 128, (kernel_size, 1), (stride, 1), padding=(kernel_size // 2, 0))),
                weight_norm(Conv2d(128, 128, (kernel_size, 1), (stride, 1), padding=(kernel_size // 2, 0))),
                weight_norm(Conv2d(128, 128, (kernel_size, 1), (1, 1), padding=(kernel_size // 2, 0))),
            ]
        )
        ...
        self.conv_post = weight_norm(Conv2d(128, 1, (3, 1), 1, padding=(1, 0)))
